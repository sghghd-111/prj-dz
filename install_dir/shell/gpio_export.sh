...
#DO-2 gpio3-14
gpio_set_out 110
ln -s /sys/class/gpio/gpio110/value /dev/do2
#DO-1 gpio3-18
gpio_set_out 114
ln -s /sys/class/gpio/gpio114/value /dev/do1
#PPS-SEL gpio3-21
gpio_set_out 117
...
#DI-1 gpio3-16
gpio_set_in 112
ln -s /sys/class/gpio/gpio112/value /dev/di1
#DI-2 gpio3-17
gpio_set_in 113
ln -s /sys/class/gpio/gpio113/value /dev/di2
